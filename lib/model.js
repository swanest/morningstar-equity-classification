...
function MorningEquityClassification(data, index, strongIndex) {
...
MorningEquityClassification.prototype = {
...
module.exports = new MorningEquityClassification(data, index, strongIndex);